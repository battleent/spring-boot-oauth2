...
import com.example.lckdive.responses.AccessTokenResponse
...
class OAuthController(
    ...
    fun code(@RequestParam code: String): AccessTokenResponse? {
        val headers = HttpHeaders().apply {
            ...
            this.setBasicAuth("lck-dive-client", "pass")
        }

        val data = LinkedMultiValueMap<String, String>()
        data.add("code", code)
        data.add("grant_type", "authorization_code")
        data.add("redirect_uri", "http://localhost:9092/oauth2/callback")
